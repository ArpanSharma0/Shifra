  ...
  `;
    ...
    recognition.interimResults =
            ...
            try {
                ...
                if(data.success){
                    ...
                    if(data.action === "navigate"){
                        ...
                        // Add AI navigation response to chat history
                        chatHistory.push({
                            role: "model",
                        ...
                        chatHistory.push({
                            role: "model",
                            parts: [{ text: data.aiResponse }]
                        });
                    }

                }else{
                    speak("Response Error please Check your plan")
                    // Remove the last user query if it failed to get a response
                    chatHistory.pop();
                }
      ...
      recognition.onerror = (e)=>{
        ...
        if (e.error === 'no-speech' && isConversationActive) {
            setTimeout(() => {
                if (isConversationActive) {
